...
# MANDATORY UI/UX CONDITION: NO NEON DESIGN

This rule applies to the entire Connect Plus interface and has priority over any conflicting visual suggestion in this document.

**Do not use neon or neon-based visual design anywhere.**
...
- Futuristic neon backgrounds
- Glowing UI effects
- Color combinations intended to imitate neon lighting
- Neon-based hover/focus effects
- Neon-style icons or logos
- Neon particles or ambient effects

Do not simulate neon through blur, outer-glow, bloom, intense saturation, or luminous gradients.

The UI must remain **professional, academic, calm, tactile, and production-oriented**.

Claymorphism must use soft physical depth and restrained shadows, **not glow-based depth**.

All hover, focus, active, selected, success, warning, and notification states must use clear solid/soft-surface treatments rather than neon or luminous effects.

This condition applies consistently to:
...
Never introduce a neon theme as an alternative theme or optional visual mode.
